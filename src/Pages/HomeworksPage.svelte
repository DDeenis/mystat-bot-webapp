<script lang="ts">
  import { MystatHomeworkStatus, MystatHomeworkType } from 'mystat-api/dist/types';
  ...
  const fetchHomeworks = (status: MystatHomeworkStatus, page: number, type: MystatHomeworkType) => {
...
<div class="hw-container">
  <div class="element">
    <Multiselect variants={hwLocalizedVariants} bind:selectedVariant={localizedStatus} />
  </div>
  <div class="element">
    <Multiselect variants={hwLocalizedTypes} bind:selectedVariant={localizedType} />
  </div>
